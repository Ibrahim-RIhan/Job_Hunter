...
import { faCalendar, faDollar, faLandmark, faLocationPin, faMailBulk, faPhone, faVoicemail } from '@fortawesome/free-solid-svg-icons'
        ...
        <div>
            ...
            <section className='md:flex justify-between gap-5 my-28 '>
                ...
                <div className='rightContainer p-8 rounded-lg'>
                    ...
                    <button className='rounded-lg px-10 py-5 my-7 w-full  text-white text-lg font-semibold  bg-[#7E90FE] '>Apply NOW</button>
                </div>
            </section>
